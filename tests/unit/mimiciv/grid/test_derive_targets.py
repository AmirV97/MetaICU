...
Mirrors tests/unit/grid/test_derive_targets.py -- add_derived_tte_targets is dataset-agnostic
logic ported verbatim from aumcdb in Stage 1, so the test content is unchanged besides the
import path."""
...
from metaicu.mimiciv.grid.build.derive_targets import add_derived_tte_targets
