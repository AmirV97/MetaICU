...
#SBATCH --output=REDACTED_PATH/audits/aumc_bounded_pipeline_%j.log

set -euo pipefail

PYTHON="REDACTED_PATH/.venvs/ethos/.venv/bin/python"
PARENT_DIR="REDACTED_PATH/audits/aumc_bounded_pipeline_${SLURM_JOB_ID}"
RAW_DIR="REDACTED_PATH/Datasets/AmsterdamUMCdb"
EXTERNAL_ROOT="REDACTED_PATH/amsterdam_external"
OMOP_VOCAB_DIR="REDACTED_PATH/omop_vocab"
...
"${PYTHON}" -m metaicu.cli.build_amsterdam_tokenized \
  paths.parent_dir="${PARENT_DIR}" \
