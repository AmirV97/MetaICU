"""Hydra CLI for the iCareFM-style MIMIC-IV grid feature manifest."""
...
from metaicu.mimiciv.grid.manifest import GridManifestConfig, write_grid_manifest_outputs
...
def _build_config(cfg: DictConfig) -> GridManifestConfig:
    ...
    return GridManifestConfig(
        output_manifest=_resolve_required(cfg, "output_manifest", parent_dir, "grid/mimic_grid_feature_manifest.csv"),
        audit_dir=_resolve_required(cfg, "audit_dir", parent_dir, "audits/grid_manifest"),
        raw_data_dir=_resolve_required(cfg, "raw_data_dir", parent_dir, "data/raw"),
