"""
Copied verbatim from AUMC_grid_pipeline/grid/assemble.py -- dataset-agnostic (operates purely
on admissionid/tag/hour-keyed long DataFrames, no AUMC-specific table/column knowledge), so no
changes needed for MIMIC. "admissionid" holds MIMIC stay_id values here, same convention used
throughout M4_grid/grid.
